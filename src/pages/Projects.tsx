  ...
  return (
    <div id="projects" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-12">
            ...
            <ProjectItem img={uaisearch} title='UaiSearch' tech='Next.js + Tailwind + Google APIs  ' githubLink='https://github.com/AlexandreRocha-10/uaisearch' appLink='https://uaisearch.vercel.app/' />
